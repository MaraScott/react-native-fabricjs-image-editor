...
### Templates - Page Layouts & Reusable Popovers
...
│
├── ToolSettingsPopover.tsx            # Tool settings panel
├── CanvasSettingsPopover.tsx          # Canvas configuration panel
├── LayersPopover.tsx                  # Layers management panel
└── ZoomControlPopover.tsx             # Zoom controls panel
```

...
const noopIcon: IconRenderer = (props) =>
    createSvg(props, <circle cx={12} cy={12} r={8} strokeDasharray="1 3" />);
...
const icons: Record<MaterialCommunityIconName, IconRenderer> = {
    ...
    'pencil-outline': (props) =>
        createSvg(
            props,
            <>
                <path d="M4 15.75l.75-3 9-9 3.5 3.5-9 9-3 .75z" fill={props.color} fillOpacity={0.2} stroke="none" />
                <path d="M4 15.75l-.75 3.75L7 18.75" />
                <path d="M12.75 3.75l3.5 3.5" />
                <path d="M6.5 17l2.5 2.5" />
            </>,
        ),
    'vector-polyline': (props) =>
        createSvg(
            props,
            <>
                <polyline points="4 5 9 5 12 12 16 9 20 9" />
                <circle cx={4} cy={5} r={1.6} fill={props.color} />
                <circle cx={9} cy={5} r={1.6} fill={props.color} />
                <circle cx={12} cy={12} r={1.6} fill={props.color} />
                <circle cx={16} cy={9} r={1.6} fill={props.color} />
                <circle cx={20} cy={9} r={1.6} fill={props.color} />
            </>,
        ),
    'rectangle-outline': (props) =>
        createSvg(props, <rect x={4.5} y={6.5} width={15} height={11} rx={2.5} />),
    'circle-outline': (props) => createSvg(props, <circle cx={12} cy={12} r={6.5} />),
    'ellipse-outline': (props) => createSvg(props, <ellipse cx={12} cy={12} rx={7.5} ry={5.5} />),
    'triangle-outline': (props) =>
        createSvg(props, <polygon points="12 5 4.5 18 19.5 18 12 5" fill="none" />),
    'ray-start-end': (props) =>
        createSvg(
            props,
            <>
    ...
    'image-outline': (props) =>
        createSvg(
            ...
            <>
                ...
                <circle cx={9} cy={10} r={1.6} fill={props.color} />
                <path d="M5 16l4-4 3.5 3.5 2.5-2.5 4 4" />
            </>,
        ),
    'arrow-collapse-horizontal': (props) =>
        createSvg(
            props,
            <>
    ...
    'file-image': (props) =>
        createSvg(
            ...
            <>
                ...
                <circle cx={11} cy={10} r={1.4} fill={props.color} />
